            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/manage-order-finished')}}">Đơn hàng đã xử lý</a></li>
						<li><a href="{{URL::to('/manage-order-unfinished')}}">Đơn hàng chưa xử lý</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
...
<script>
    $('.comment_active_btn').click(function(){
        var comment_status = $(this).data('comment_status');
        var comment_id = $(this).data('comment_id');
        var comment_product_id = $(this).attr('id');
        if(comment_status == 0){
            var alert = 'thay doi duyet thanh cong';
        }else{
            var alert = 'thay doi khong duyet thanh cong';
        }
        $.ajax({
