						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="reviews" >
								<div class="col-sm-12">
									...
									<p>Viet danh gia cua ban</p>
									
									<form action="#">
										<span >
											<input style="width: 100%; margin-left: 0;" type="hidden" class="comment_name" placeholder="" value="<?php echo Session::get('customer_name')?>"/>
										</span>
											 ...
											 <div class="single-products">
											 	<a href="{{URL::to('chi-tiet-san-pham/'.$lienquan->product_id)}}">
		                                        	<div class="productinfo text-center">
		                                            	<img src="{{URL::to('public/upload/product/'.$lienquan->product_image)}}" height="180" alt="" />
